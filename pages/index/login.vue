	...
	<view class="pageBackground" :style="{'height':isHeight+'px'}">
		...
		<view class="screen">
			...
			<view class="uni-form-item uni-column uni-column11">
				<view class="title title1"><image src="../../static/user.png" mode=""></image></view>
				<input class="uni-input" type="text" :value="username" @input="setUsername" placeholder="请输入用户名" />
			</view>

			<view class="uni-form-item uni-column uni-column11">
				<view class="title title1"><image src="../../static/password.png" mode=""></image></view>
				<input class="uni-input" type="text" :value="password" password @input="setPassword" placeholder="请输入密码" />
			</view>
