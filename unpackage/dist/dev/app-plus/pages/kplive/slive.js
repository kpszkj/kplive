  ...
  return _c(
    ...
    [
      _c("view", { staticClass: ["container"] }, [
        _c("view", { style: { height: _vm.stateHeight + "px" } }, [
          _c("u-text", [_vm._v(" \n\t")])
        ]),
        _c(
          "view",
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      //屏幕方向 0竖屏 1横屏\n      screen: 1,\n      //直播状态\n      lState: false,\n      //屏幕高度\n      screenWidth: '',\n      //图片路径\n      srcUrl: 'https://bjetxgzv.cdn.bspapp.com/VKCEYUGU-uni-app-doc/6acec660-4f31-11eb-a16f-5b3e54966275.jpg',\n      //倒计时\n      isDown: false,\n      dowNum: 4,\n      //获取屏幕高度\n      isHeight: 0,\n      //秒 分 时\n      s: 0,\n      m: 0,\n      h: 0,\n      iTime: '00:00:00',\n      timer: 0,\n      //状态栏高度\n      stateHeight: 0 };\n\n  },\n  onReady: function onReady() {\n    __f__(\"log\", '111横屏直播页面', \" at pages/kplive/slive.nvue:104\");\n    /* 切换横屏 */\n    plus.screen.lockOrientation('landscape-primary');\n    // 注意：需要在onReady中 或 onLoad 延时\n    this.context = uni.createLivePusherContext(\"livePusher\", this);\n    this.startPreview();\n    this.info();\n  },\n  onBackPress: function onBackPress(options) {//用户物理返回键\n\n    if (this.lState == true) {\n      return true;\n    }\n    plus.screen.lockOrientation('portrait-primary');\n    __f__(\"log\", \"用户按下物理返回键\", \" at pages/kplive/slive.nvue:118\");\n\n  },\n  methods: {\n    info: function info() {\n      __f__(\"log\", 'Info111', \" at pages/kplive/slive.nvue:123\");\n      var that = this;\n      uni.getSystemInfo({\n        success: function success(res) {\n          __f__(\"log\", res.model, \" at pages/kplive/slive.nvue:127\");\n          __f__(\"log\", res.pixelRatio, \" at pages/kplive/slive.nvue:128\");\n          __f__(\"log\", res.windowWidth, \" at pages/kplive/slive.nvue:129\");\n          __f__(\"log\", res.windowHeight, \" at pages/kplive/slive.nvue:130\");\n          __f__(\"log\", res.language, \" at pages/kplive/slive.nvue:131\");\n          __f__(\"log\", res.version, \" at pages/kplive/slive.nvue:132\");\n          __f__(\"log\", res.platform, \" at pages/kplive/slive.nvue:133\");\n          __f__(\"log\", res.deviceId, \" at pages/kplive/slive.nvue:134\");\n          //that.stateHeight = res.statusBarHeight;\n          that.isHeight = res.screenWidth;\n          // that.isHeight = res.screenWidth - res.statusBarHeight - 2;\n        } });\n\n    },\n    finality: function finality() {\n      this.$emit('finish');\n    },\n    statechange: function statechange(e) {\n      //console.log(\"statechange:\" + JSON.stringify(e));\n    },\n    netstatus: function netstatus(e) {\n      // console.log(\"netstatus:\" + JSON.stringify(e));\n    },\n    error: function error(e) {\n      __f__(\"log\", \"error:\" + JSON.stringify(e), \" at pages/kplive/slive.nvue:151\");\n    },\n    start1: function start1() {\n      this.lState = true;\n      // timeOut();\n      this.countDown();\n    },\n    countDown: function countDown() {\n      // function timeOut() {\n      if (this.dowNum != 0) {\n        var that = this;\n        setTimeout(function () {\n          that.isDown = true;\n          that.dowNum--;\n          __f__(\"log\", that.dowNum + 'aaa', \" at pages/kplive/slive.nvue:165\");\n          that.countDown();\n        }, 1000);\n      } else {\n        this.start();\n      }\n      // }\n    },\n    reClick: function reClick() {\n\n      /* uni.navigateTo({\n                                 \turl: \"/pages/index/index\"\n                                 }); */\n      plus.screen.lockOrientation('portrait-primary');\n      uni.navigateBack({\n        delta: 1 });\n\n      __f__(\"log\", '返回', \" at pages/kplive/slive.nvue:182\");\n\n    },\n    start: function start() {var _this = this;\n      this.context.start({\n        success: function success(a) {\n          __f__(\"log\", \"livePusher.start:\" + JSON.stringify(a), \" at pages/kplive/slive.nvue:188\");\n          _this.lState = true;\n          _this.isDown = false;\n\n\n          var that = _this;\n          _this.timer = setInterval(function () {\n            that.s++;\n            if (that.s > 59) {\n              that.s = 0;\n              that.m++;\n            }\n            if (that.m > 11) {\n              that.m = 0;\n              that.h++;\n            }\n            if (that.h > 23) {\n              that.m = 0;\n              that.s = 0;\n              // that.clearInterval(Timer);\n            }\n            that.iTime = that.h + ':' + that.m + ':' + that.s;\n            __f__(\"log\", '直播时间' + that.iTime, \" at pages/kplive/slive.nvue:210\");\n          }, 1000);\n        } });\n\n\n    },\n    close: function close() {\n      this.context.close({\n        success: function success(a) {\n          __f__(\"log\", \"livePusher.close:\" + JSON.stringify(a), \" at pages/kplive/slive.nvue:219\");\n        } });\n\n    },\n    snapshot: function snapshot() {\n      this.context.snapshot({\n        success: function success(e) {\n          __f__(\"log\", JSON.stringify(e), \" at pages/kplive/slive.nvue:226\");\n        } });\n\n    },\n    resume: function resume() {\n      this.context.resume({\n        success: function success(a) {\n          __f__(\"log\", \"livePusher.resume:\" + JSON.stringify(a), \" at pages/kplive/slive.nvue:233\");\n        } });\n\n    },\n    pause: function pause() {\n      this.context.pause({\n        success: function success(a) {\n          __f__(\"log\", \"livePusher.pause:\" + JSON.stringify(a), \" at pages/kplive/slive.nvue:240\");\n        } });\n\n    },\n    stop: function stop() {var _this2 = this;\n      this.context.stop({\n        success: function success(a) {\n          _this2.lState = false;\n          __f__(\"log\", JSON.stringify(a), \" at pages/kplive/slive.nvue:248\");\n        } });\n\n    },\n    popup: function popup() {\n      this.$refs.popup.open();\n\n\n    },\n    popup1: function popup1() {\n      __f__(\"log\", '22', \" at pages/kplive/slive.nvue:258\");\n      this.$refs.popup1.open();\n    },\n    close1: function close1(done) {\n\n      done();\n    },\n    confirm: function confirm(done, value) {\n      this.stop();\n      clearInterval(this.timer);\n      __f__(\"log\", '结束时长' + this.iTime, \" at pages/kplive/slive.nvue:268\");\n      // 输入框的值\n      __f__(\"log\", value, \" at pages/kplive/slive.nvue:270\");\n      /* 竖屏展示 */\n      plus.screen.lockOrientation('portrait-primary');\n      uni.redirectTo({\n        url: \"/pages/kplive/over?iTime=\" + this.iTime + \"&srcUrl=\" + this.srcUrl });\n\n      done();\n    },\n    switchCamera: function switchCamera() {\n      this.context.switchCamera({\n        success: function success(a) {\n          __f__(\"log\", \"livePusher.switchCamera:\" + JSON.stringify(a), \" at pages/kplive/slive.nvue:281\");\n        } });\n\n    },\n    startPreview: function startPreview() {\n      this.context.startPreview({\n        success: function success(a) {\n          //console.log(\"livePusher.startPreview:\" + JSON.stringify(a));\n        } });\n\n    },\n    stopPreview: function stopPreview() {\n      this.context.stopPreview({\n        success: function success(a) {\n          __f__(\"log\", \"livePusher.stopPreview:\" + JSON.stringify(a), \" at pages/kplive/slive.nvue:295\");\n        } });\n\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 41)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///40\n");
