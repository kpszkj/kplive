      ...
      _c("view", { staticClass: ["container"] }, [
        _c(
          ...
          [
            ...
            _vm.liveStatus == -1
              ? _c("u-image", {
                  staticClass: ["w_btn", "overturnBtn1"],
                  attrs: { src: "../../static/overturn.png" },
                  on: { click: _vm.switchCamera }
                })
              : _vm._e(),
            _vm.liveStatus == 0
              ? _c(
                  "button",
                  { staticClass: ["returna"], on: { click: _vm.back } },
                  [_vm._v("back")]
                )
              : _vm._e(),
            _vm.liveStatus == -1
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      //屏幕宽度\n      screenWidth: 0,\n      //屏幕宽度\n      screenHeight: 0,\n      //登录用户\n      luser: {},\n      //直播id\n      liveId: 0,\n      //直播时长\n      duration: '00:00:00',\n      //秒 分 时\n      s: 0,\n      m: 0,\n      h: 0,\n      //直播状态 0直播前 1倒计时 2直播中\n      liveStatus: 0,\n      //定时器id\n      timer: 0,\n      //倒计时数字\n      countNum: 3,\n      error: \"\" };\n\n  },\n  onReady: function onReady() {\n    /* 切换横屏 */\n\n    plus.screen.lockOrientation('landscape-primary');\n\n    // 注意：需要在onReady中 或 onLoad 延时\n    this.init();\n  },\n  onBackPress: function onBackPress(options) {\n    //用户物理返回键\n    //console.log(\"竖屏直播返回\");\n    //console.log(this.liveStatus);\n    if (this.liveStatus == 0) {\n\n      plus.screen.lockOrientation('portrait-primary');\n\n      //console.log(\"直播前返回\");\n    }\n    if (this.liveStatus == 1) {\n      //console.log(\"倒计时返回\");\n      return true;\n    } else if (this.liveStatus == 2) {\n      //console.log(\"直播时返回\");\n      this.$refs.popup.open();\n      return true;\n    }\n    //console.log(\"用户按下物理返回键\");\n  },\n  methods: {\n    //获取设备信息\n    init: function init() {\n      try {\n        var luser = uni.getStorageSync('luser');\n        if (luser) {\n          //console.log(luser);\n          this.luser = luser;\n          var liveId = uni.getStorageSync('liveId');\n          if (liveId) {\n            //console.log(liveId);\n            this.liveId = liveId;\n            var that = this;\n            uni.getSystemInfo({\n              success: function success(res) {\n                that.screenHeight = res.screenWidth;\n              } });\n\n            this.context = uni.createLivePusherContext(\"livePusher\", this);\n            this.startPreview();\n          }\n        } else {\n          //this.toLogin();\n        }\n      } catch (e) {\n        __f__(\"log\", 'err' + e, \" at pages/kplive/hkplive.nvue:159\");\n      }\n    },\n    //返回按钮\n    back: function back() {\n      //plus.screen.lockOrientation('portrait-primary');\n      //console.log('竖屏返回');\n\n      plus.screen.lockOrientation('portrait-primary');\n\n      uni.navigateBack({\n        delta: 1 });\n\n    },\n    countDown: function countDown() {\n      if (this.liveStatus == 0) {\n        this.liveStatus = 1;\n      }\n      // function timeOut() {\n      if (this.countNum != 0) {\n        var that = this;\n        setTimeout(function () {\n          that.countNum--;\n          __f__(\"log\", '倒计时：' + that.countNum, \" at pages/kplive/hkplive.nvue:182\");\n          that.countDown();\n        }, 1000);\n      } else {\n        this.start();\n      }\n    },\n    popup: function popup() {\n      this.$refs.popup.open();\n    },\n    popup1: function popup1() {\n      this.$refs.popup1.open();\n    },\n    close1: function close1(done) {\n      done();\n    },\n    confirm: function confirm(done, value) {\n      this.stop();\n      clearInterval(this.timer);\n      __f__(\"log\", '结束时长' + this.duration, \" at pages/kplive/hkplive.nvue:201\");\n      done();\n    },\n\n\n    /* 直播组件相关 */\n    statechange: function statechange(e) {\n      //console.log(\"statechange:\" + JSON.stringify(e));\n    },\n    netstatus: function netstatus(e) {\n      // console.log(\"netstatus:\" + JSON.stringify(e));\n    },\n    error: function error(e) {\n      //console.log(\"error:\" + JSON.stringify(e));\n    },\n    startPreview: function startPreview() {\n      this.context.startPreview({\n        success: function success(a) {\n          //console.log(\"livePusher.startPreview:\" + JSON.stringify(a));\n        } });\n\n    },\n    switchCamera: function switchCamera() {\n      this.context.switchCamera({\n        success: function success(a) {\n          //console.log(\"livePusher.switchCamera:\" + JSON.stringify(a));\n        } });\n\n    },\n    start: function start() {var _this = this;\n      this.context.start({\n        success: function success(a) {\n          uni.request({\n            url: 'http://192.168.0.110:8080/kp/live/start.do',\n            data: {\n              liveId: _this.liveId },\n\n            header: {\n              //自定义请求头信息\n              //'custom-header': 'hello'\n            },\n            method: \"GET\",\n            success: function success(res) {\n              __f__(\"log\", res.data, \" at pages/kplive/hkplive.nvue:244\");\n              if (res.data.success) {\n                _this.changeStatus();\n              } else {\n                _this.error = res.data.message;\n                _this.$refs.error.open();\n              }\n            } });\n\n          //console.log(\"livePusher.start:\" + JSON.stringify(a));\n\n        } });\n\n    },\n    changeStatus: function changeStatus() {\n      this.liveStatus = 2;\n      var that = this;\n      this.timer = setInterval(function () {\n        that.s++;\n        if (that.s > 59) {\n          that.s = 0;\n          that.m++;\n        }\n        if (that.m > 11) {\n          that.m = 0;\n          that.h++;\n        }\n        if (that.h > 23) {\n          that.m = 0;\n          that.s = 0;\n        }\n        that.duration = that.h + ':' + that.m + ':' + that.s;\n        __f__(\"log\", '直播时间' + that.duration, \" at pages/kplive/hkplive.nvue:276\");\n      }, 1000);\n    },\n    stop: function stop() {var _this2 = this;\n      this.context.stop({\n        success: function success(a) {\n          _this2.liveStatus = 3;\n          //console.log(JSON.stringify(a));\n          uni.request({\n            url: 'http://192.168.0.110:8080/kp/live/stop.do',\n            data: {\n              liveId: _this2.liveId,\n              duration: _this2.duration },\n\n            header: {\n              //自定义请求头信息\n              //'custom-header': 'hello'\n            },\n            method: \"GET\",\n            success: function success(res) {\n              //console.log(res.data);\n              if (res.data.success) {\n\n                plus.screen.lockOrientation('portrait-primary');\n\n                uni.redirectTo({\n                  url: \"/pages/kplive/liveover?duration=\" + _this2.\n                  duration,\n                  success: function success(a) {\n                    //console.log(\"livePusher.pause:\" + JSON.stringify(a));\n                  },\n                  fail: function fail(a) {\n                    //console.log(a);\n                  } });\n\n              } else {\n                _this2.error = res.data.message;\n                _this2.$refs.error.open();\n              }\n            } });\n\n        } });\n\n    }\n\n    /* finality: function() {\n      \tthis.$emit('finish');\n      },\n      snapshot: function() {\n      \tthis.context.snapshot({\n      \t\tsuccess: (e) => {\n      \t\t\tconsole.log(JSON.stringify(e));\n      \t\t}\n      \t});\n      },\n      resume: function() {\n      \tthis.context.resume({\n      \t\tsuccess: (a) => {\n      \t\t\tconsole.log(\"livePusher.resume:\" + JSON.stringify(a));\n      \t\t}\n      \t});\n      },\n      pause: function() {\n      \tthis.context.pause({\n      \t\tsuccess: (a) => {\n      \t\t\tconsole.log(\"livePusher.pause:\" + JSON.stringify(a));\n      \t\t}\n      \t});\n      }, \n      close: function() {\n      \tthis.context.close({\n      \t\tsuccess: (a) => {\n      \t\t\tconsole.log(\"livePusher.close:\" + JSON.stringify(a));\n      \t\t}\n      \t});\n      },\n      stopPreview: function() {\n      \tthis.context.stopPreview({\n      \t\tsuccess: (a) => {\n      \t\t\tconsole.log(\"livePusher.stopPreview:\" + JSON.stringify(a));\n      \t\t}\n      \t});\n      } */ } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 48)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///47\n");
